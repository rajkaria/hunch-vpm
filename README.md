...
Nothing is deployed yet. Every manifest and address file carries an explicit zero-address
placeholder, the web surface renders from a fixture layer with no network, and the agent
defaults to dry-run. [`docs/RUNBOOK.md`](docs/RUNBOOK.md) is the deploy path.
